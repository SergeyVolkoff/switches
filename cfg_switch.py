...
class TridentCfg(CfgTemplate):
    ...
    def extended_reset_cfg(self):
        """
        Ф-я подключения по консоли к DUT,
        сброса настроек,настройка hostname, 
        настройка eth0 для проверки пингом доступности DUT.
        """
        ...
        if 'y' == result_input:
            ...
            CONSOLE.print(output,"Swich rebooting! Wait, please +-70sec",style="success")
            time.sleep(75)
